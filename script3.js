...
/*Download */
 ...
 document.addEventListener("DOMContentLoaded", function() {
    ...
    mensagem.innerHTML = '<p><i class="fas fa-exclamation-triangle" style="color: yellow; margin-right: 10px;"></i>Este Dashboard4Skills não receberá mais atualizações via downloads.</p><p>Efetue o download desta última atualização, pois a partir dela:</p><p><li>As atualizações serão automáticas.</li><li>Não haverá necessidade de novos downloads.</li></p> <p>REMOVA o(s) arquivo(s) antigo(s) e mantenha APENAS este novo.</p>';
